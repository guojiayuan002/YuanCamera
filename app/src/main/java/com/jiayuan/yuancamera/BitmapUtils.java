...
import static com.jiayuan.yuancamera.SystemUtils.dp2px;
...
public class BitmapUtils {
    ...
    public static Bitmap zoomBitmap(Bitmap bitmap, float width, float height) {
        ...
        //x:起始坐标,起始y坐标,width：要截的图的宽度 height：要截的图的宽度
...
*/
     ...
     * @param fileName
     */
    public static String saveSystemPhoto(Context context, Bitmap bitmap, String fileName) {

        File appDir = new File(Environment.getExternalStorageDirectory(), "jiayaun");//将要保存图片的路径
